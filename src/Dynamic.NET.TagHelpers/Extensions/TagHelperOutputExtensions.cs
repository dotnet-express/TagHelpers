...
namespace Dynamic.NET.TagHelpers.Extensions
{
    ...
    {
        /// <summary>
        /// Set tag name in output
        /// </summary>
        /// <param name="output"></param>
        /// <param name="tagName">Output tag name</param>
        public static void SetTagName(this TagHelperOutput output, string tagName)
        {
            output.TagName = tagName;
        }

        /// <summary>
        /// Set tag name and add default css class in output
        /// </summary>
        /// <param name="output"></param>
        /// <param name="tagName">Output tag name</param>
        /// <param name="cssClass">Default css class</param>
        public static void SetTagInfo(this TagHelperOutput output, string tagName, string cssClass)
        {
            SetTagInfo(output, tagName, cssClass, TagMode.StartTagAndEndTag);
        }

        /// <summary>
        /// Set tag name, tag mode and add default css class in output
        /// </summary>
        /// <param name="output"></param>
        /// <param name="tagName">Output tag name</param>
        /// <param name="cssClass">Default css class</param>
        /// <param name="tagMode">Tag mode</param>
        public static void SetTagInfo(this TagHelperOutput output, string tagName, string cssClass, TagMode tagMode)
        {
            output.TagName = tagName;
        ...
        public static void AddCssClass(this TagHelperOutput output, string cssClass, bool isFirst = false)
        {
            if (cssClass.IsNullOrEmpty()) return;

            AddCssClass(output, new[] { cssClass }, isFirst);
        }
        ...
        public static void AddCssClass(this TagHelperOutput output, IEnumerable<string> cssClasses, bool isFirst = false)
        {
        ...
        public static void AddCssStyle(this TagHelperOutput output, string name, string value)
        {
            if (output.Attributes.ContainsName("style"))
            {
                ...
                {
                    var styleText = output.Attributes["style"].Value.ToString();
                    output.Attributes.SetAttribute("style", styleText + (styleText.EndsWith(";") ? " " : "; ") + name + ": " + value + ";");
                }
            }
            else
            {
